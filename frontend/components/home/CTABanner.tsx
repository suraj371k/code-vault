  ...
  return (
    <section className="relative py-28 px-4 sm:px-6 lg:px-8 overflow-hidden">
      ...
      <div className="absolute inset-0 pointer-events-none"
           style={{ background:'radial-gradient(ellipse 60% 60% at 50% 50%,rgba(20,184,166,.09) 0%,transparent 70%)' }} />
      ...
      <div className="max-w-3xl mx-auto text-center relative z-10"
        ...
        <h2 className="text-4xl md:text-6xl font-bold font-mono text-white mb-4 leading-tight">
          Your team's code<br />deserves a{' '}
          <span className="shimmer-text">smarter home.</span>
        </h2>
