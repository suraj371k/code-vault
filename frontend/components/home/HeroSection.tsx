  ...
  return (
    <section className="relative pt-36 pb-24 px-4 sm:px-6 lg:px-8 overflow-hidden">
      ...
      <div className="max-w-5xl mx-auto text-center relative z-10">
        {/* Eyebrow badge */}
        <div
          className="hero-animate inline-flex items-center gap-2 mb-8 px-4 py-2 rounded-full text-xs font-medium"
          style={{
        ...
        <p className="hero-animate-2 text-lg md:text-xl text-zinc-400 mb-8 max-w-2xl mx-auto leading-relaxed">
          Organize snippets, collaborate in real-time, and let AI summarize,
          explain, and chat with your code — all in one vault.
        </p>
        ...
        <div className="hero-animate-5 relative mx-auto max-w-3xl card-bob">
          {/* glow ring */}
          <div
            className="absolute -inset-px rounded-2xl card-border-glow"
            style={{
              background:
                "linear-gradient(135deg,rgba(20,184,166,0.2),rgba(6,182,212,0.1),rgba(99,102,241,0.1))",
              borderRadius: 16,
            }}
          />
          ...
          <div className="relative glass-card rounded-2xl p-6 md:p-8">
            ...
            <div className="code-block rounded-xl p-5 mb-4 font-mono text-sm text-left">
              <CodeLine delay={200}>
                <Token color="#818cf8" delay={220}>
                  const
                </Token>
                <span className="text-zinc-500"> </span>
                <Token color="#2dd4bf" delay={280}>
                  buildAmazing
                </Token>
                <Token color="#71717a" delay={320}>
                  {" "}
                  ={" "}
                </Token>
                <Token color="#818cf8" delay={360}>
                  async
                </Token>
                <Token color="#a1a1aa" delay={400}>
                  {" "}
                  (){" "}
                </Token>
                <Token color="#71717a" delay={440}>
                  =&gt;{" "}
                </Token>
                <Token color="#71717a" delay={480}>
                  {"{"}
                </Token>
              </CodeLine>
              ...
              <CodeLine delay={550}>
                ...
                <Token color="#818cf8" delay={570}>
                  const
                </Token>
                <Token color="#a1a1aa" delay={610}>
                  {" "}
                  result{" "}
                </Token>
                <Token color="#71717a" delay={640}>
                  ={" "}
                </Token>
                <Token color="#818cf8" delay={670}>
                  await{" "}
                </Token>
                <Token color="#14b8a6" delay={710}>
                  codeVault
                </Token>
                <Token color="#71717a" delay={740}>
                  .
                </Token>
                <Token color="#06b6d4" delay={770}>
                  collaborate
                </Token>
                <Token color="#a1a1aa" delay={800}>
                  ()
                </Token>
                <Token color="#71717a" delay={820}>
                  ;
                </Token>
              </CodeLine>
              ...
              <CodeLine delay={880}>
                <span className="text-zinc-600 select-none ml-4"> </span>
                <Token color="#818cf8" delay={900}>
                  return{" "}
                </Token>
                <Token color="#a1a1aa" delay={940}>
                  result
                </Token>
                <Token color="#71717a" delay={970}>
                  .
                </Token>
                <Token color="#06b6d4" delay={1000}>
                  shipFaster
                </Token>
                <Token color="#a1a1aa" delay={1030}>
                  ()
                </Token>
                <Token color="#71717a" delay={1050}>
                  ;
                </Token>
              </CodeLine>

              <CodeLine delay={1100}>
                <Token color="#71717a" delay={1120}>
                  {"}"}
                </Token>
                <Token color="#71717a" delay={1140}>
                  ;
                </Token>
              </CodeLine>
            </div>
            ...
            >
              <div className="flex items-center gap-2 mb-2">
                ...
                <p className="text-xs text-teal-500 font-mono font-semibold">
                  AI Assistant
                </p>
              </div>
              <p className="text-sm text-zinc-300 leading-relaxed">
                This async function initialises real-time collaboration and
                returns an optimised shipping pipeline. Uses Promise-based flow
                for non-blocking team sync.
              </p>
            </div>
          </div>
        </div>
