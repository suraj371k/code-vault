...
const ChatWindow = ({ conversation, currentUserId }: ChatWindowProps) => {
  ...
  const headerTitle = conversation.participants
    ...
    <div className="flex flex-col h-full overflow-hidden">
      ...
      >
        <div className="relative">
          <Avatar className="size-9" style={{ boxShadow: '0 0 0 1px rgba(20,184,166,0.3)' }}>
            <AvatarFallback
        ...
        <div>
          <p className="text-[13px] font-semibold text-zinc-100 leading-none">{headerTitle}</p>
          <p className="text-[11px] text-teal-500/70 mt-0.5 leading-none">Online</p>
        </div>
      </div>
