...
import { addMembers, createOrganization, deleteOrganization, getMembers, getMyOrganizations, getOrganizationBySlug, removeMember, getOnlineStatus, } from "../controllers/organization.controller.js";
...
router.delete("/:organizationId/member/:memberId", authMiddleware, removeMember);
